...
export function createFieldExtractor(customFields: Task['custom_fields']) {
  ...
  const creatorSchema = z.object({
    ...
    const extractFieldValue = (discoveredField: CustomField | null): string | null => {
    ...
    const extractNumber = (discoveredField: CustomField | null): number | null => {
    ...
    return {
      profileImageUrl: extractFieldValue(discoveredFields.profileImageUrl) || DEFAULT_PROFILE_IMAGE,
